...
<body>
    <header class="hero">
        <nav class="nav container">
            ...
            <ul class="nav__link nav__link--menu">
                ...
                <li class="nav__items">
                    <a href="tablas.html" class="nav__links" id="user-icon-link">
                        <img src="img/bx-list-plus.svg" alt="#" class="nav__user-icon">
                    </a>
                </li>
    ...
    <script src="./js/MjsAdmin.js"></script>
    <script src="./js/jslistartabla.js"></script>
</body>
