...
<body>
      <header class="header">
        <nav class="navbar container">
            ...
            <ul class="navbar__links navbar__links--menu">
                <li class="nav__items">
                    <a href="tablas.html" class="nav__links">Inicio</a>
                </li>
                <li class="nav__items">
    ...
    <!-- Título de la página -->
    <h1 class="custom-title">Lista Paquetes</h1>
    
    <!-- Contenedor para el botón de agregar un nuevo paquete -->
    <div class="custom-new-button-container">
        <!-- Enlace para acceder al formulario de nuevo paquete -->
        <a href="nuevoPaquete.html" class="custom-button">Nuevo Paquete</a>
    </div>
    
    <?php
    // Incluye el archivo del modelo que contiene la definición de la clase Paquete
    include_once '../Modelo/mdlPaquetes.php';

    // Crea una instancia de la clase Paquete
    $paquete = new Paquete();
    
    // Llama al método ListarPaquetes() para mostrar todos los paquetes en una tabla
